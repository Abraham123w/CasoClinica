public abstract class Trabajador {
	...
	public Trabajador(String tituloProfesional, String nombre, String direccion, String estadoCivil, int rut, String horariodDeTrabajo) {
		this.tituloProfesional=tituloProfesional;
		this.nombre=nombre;
		this.direccion=direccion;
		this.estadoCivil=estadoCivil;
		this.rut=rut;
		this.HorarioDeTrabajo=horariodDeTrabajo;
	}
	...
	public String getHorarioDeTrabajo() {
		// TODO - implement Trabajador.getHorarioDeTrabajo
		throw new UnsupportedOperationException();
	}


	public void setHorarioDeTrabajo(String HorarioDeTrabajo) {
		// TODO - implement Trabajador.setHorarioDeTrabajo
		throw new UnsupportedOperationException();
	}

	public void getTipo() {
		// TODO - implement Trabajador.getTipo
		throw new UnsupportedOperationException();
	}
